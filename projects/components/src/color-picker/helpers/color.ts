...
export class Color {
   ...
   */
  public setHsva(hue: number | null = null, saturation: number = 100, brightness: number = 100, alpha: number = 1): this {
    if (hue != null) {
      this.hsva.hue = hue;
    }
  ...
  private stringToColor(colorString: ColorString): this {
    ...
    let rgba: Rgba | null = ColorsTable.get(str) || null;
