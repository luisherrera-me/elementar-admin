import { GetGridLayoutDiff } from '../grid.utils';
import { compact } from '../react-grid-layout.utils';

describe('Grid utils', () => {

    describe('GetGridLayoutDiff', () => {
        it('should calculate resize grid diff', () => {
            ...
            expect(GetGridLayoutDiff(a, b)).toEqual({3: {change: 'resize'}});
        });
        ...
        it('should calculate move items grid diff', () => {
            ...
            expect(GetGridLayoutDiff(a, b)).toEqual({2: {change: 'move'}});
        });
        ...
        it('should calculate resize and move changes on the grid', () => {
            ...
            expect(GetGridLayoutDiff(a, b)).toEqual({2: {change: 'move'}, 1: {change: 'resize'}});
        });
    });
